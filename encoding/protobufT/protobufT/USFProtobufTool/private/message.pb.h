...
inline ::google::protobuf::uint32 userinfo::userid() const {
  // @@protoc_insertion_point(field_get:message.userinfo.userid)
  return userid_;
}
inline void userinfo::set_userid(::google::protobuf::uint32 value) {
  set_has_userid();
  userid_ = value;
  // @@protoc_insertion_point(field_set:message.userinfo.userid)
}
...
inline const ::std::string& userinfo::username() const {
  // @@protoc_insertion_point(field_get:message.userinfo.username)
  return *username_;
}
inline void userinfo::set_username(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:message.userinfo.username)
}
inline void userinfo::set_username(const char* value) {
  ...
  username_->assign(value);
  // @@protoc_insertion_point(field_set_char:message.userinfo.username)
}
inline void userinfo::set_username(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:message.userinfo.username)
}
inline ::std::string* userinfo::mutable_username() {
  ...
  // @@protoc_insertion_point(field_mutable:message.userinfo.username)
  return username_;
}
...
inline void userinfo::set_allocated_username(::std::string* username) {
  ...
  // @@protoc_insertion_point(field_set_allocated:message.userinfo.username)
}
...
inline const ::std::string& focustm::msgtype() const {
  // @@protoc_insertion_point(field_get:message.focustm.msgtype)
  return *msgtype_;
}
inline void focustm::set_msgtype(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:message.focustm.msgtype)
}
inline void focustm::set_msgtype(const char* value) {
  ...
  msgtype_->assign(value);
  // @@protoc_insertion_point(field_set_char:message.focustm.msgtype)
}
inline void focustm::set_msgtype(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:message.focustm.msgtype)
}
inline ::std::string* focustm::mutable_msgtype() {
  ...
  // @@protoc_insertion_point(field_mutable:message.focustm.msgtype)
  return msgtype_;
}
...
inline void focustm::set_allocated_msgtype(::std::string* msgtype) {
  ...
  // @@protoc_insertion_point(field_set_allocated:message.focustm.msgtype)
}
...
inline const ::message::userinfo& focustm::ui(int index) const {
  // @@protoc_insertion_point(field_get:message.focustm.ui)
  return ui_.Get(index);
}
inline ::message::userinfo* focustm::mutable_ui(int index) {
  // @@protoc_insertion_point(field_mutable:message.focustm.ui)
  return ui_.Mutable(index);
}
inline ::message::userinfo* focustm::add_ui() {
  // @@protoc_insertion_point(field_add:message.focustm.ui)
  return ui_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::message::userinfo >&
focustm::ui() const {
  // @@protoc_insertion_point(field_list:message.focustm.ui)
  return ui_;
}
inline ::google::protobuf::RepeatedPtrField< ::message::userinfo >*
focustm::mutable_ui() {
  // @@protoc_insertion_point(field_mutable_list:message.focustm.ui)
  return &ui_;
}
