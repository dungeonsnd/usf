...
userinfo::userinfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:message.userinfo)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:message.userinfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:message.userinfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:message.userinfo)
  return false;
#undef DO_
}
...
void userinfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:message.userinfo)
  // optional uint32 userid = 1;
  if (has_userid()) {
  ...
  // @@protoc_insertion_point(serialize_end:message.userinfo)
}
...
focustm::focustm()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:message.focustm)
}
...
focustm::focustm(const focustm& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:message.focustm)
}
...
focustm::~focustm() {
  // @@protoc_insertion_point(destructor:message.focustm)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:message.focustm)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:message.focustm)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:message.focustm)
  return false;
#undef DO_
}
...
void focustm::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:message.focustm)
  // optional string msgtype = 1;
  if (has_msgtype()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->msgtype().data(), this->msgtype().length(),
  ...
  // @@protoc_insertion_point(serialize_end:message.focustm)
}

::google::protobuf::uint8* focustm::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:message.focustm)
  // optional string msgtype = 1;
  if (has_msgtype()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->msgtype().data(), this->msgtype().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message.focustm)
  return target;
}
